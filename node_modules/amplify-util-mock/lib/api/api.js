...
class APITest {
    ...
    start(context, port = 20002, wsPort = 20003) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // check java version
                yield index_1.checkJavaVersion(context);
                ...
                yield this.generateCode(context, appSyncConfig);
    ...
    runTransformer(context, parameters = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.transformerResult = yield this.configureLambdaDataSource(context, config);
    ...
    generateCode(context, config = null) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (this.resolverOverrideManager.isTemplateFile(filePath, action === 'unlink' ? true : false)) {
                    ...
                    yield this.generateCode(context, config);
                }
                else if (filePath.includes(parameterFilePath)) {
                    const apiParameters = yield this.loadAPIParameters(context);
    ...
    ensureDDBTables(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield dynamo_db_1.createAndUpdateTable(this.ddbClient, config);
        });
    }
    configureLambdaDataSource(context, config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Object.assign(Object.assign({}, config), { dataSources: yield Promise.all(config.dataSources.map((d) => __awaiter(this, void 0, void 0, function* () {
                    if (d.type !== 'AWS_LAMBDA') {
                        return d;
                    }
                    const lambdaConfig = lambda_arn_to_config_1.lambdaArnToConfig(d.LambdaFunctionArn, provisionedLambdas);
                    const envVars = yield this.hydrateLambdaEnvVars(context, lambdaConfig.environment, config);
                    const invoker = yield amplify_category_function_1.getInvoker(context, {
    ...
    startDynamoDBLocalServer(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mockConfig = yield mock_config_file_1.getMockConfig(context);
            this.ddbEmulator = yield dynamoEmulator.launch(Object.assign({ dbPath, port: null }, mockConfig));
    ...
    hydrateLambdaEnvVars(context, sourceEnvVars, config) {
        return __awaiter(this, void 0, void 0, function* () {
            const resources = yield context.amplify.getResourceStatus();
            const allResources = resources.allResources;
            return utils_1.hydrateAllEnvVars(allResources, sourceEnvVars, {
                apiId: 'fake-api-id',
