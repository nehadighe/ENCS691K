...
exports.loadFunctionParameters = (context, resourcePath) => {
    const funcParams = context.amplify.readJsonFile(path_1.default.join(resourcePath, constants_1.functionParametersFileName), undefined, false) || {};
