...
async function migrateProject(context) {
    ...
    if (projectConfig.version !== constants_1.amplifyCLIConstants.PROJECT_CONFIG_VERSION) {
...
function generateMigrationInfo(projectConfig, projectPath) {
    const migrationInfo = {
        ...
        newVersion: constants_1.amplifyCLIConstants.PROJECT_CONFIG_VERSION,
    };
...
function generateNewProjectConfig(projectConfig) {
    ...
    newProjectConfig.version = constants_1.amplifyCLIConstants.PROJECT_CONFIG_VERSION;
