...
exports.addUserPluginPackage = async (pluginPlatform, pluginDirPath) => {
    return exports.addPluginPackage(pluginPlatform, pluginDirPath);
};
exports.addExcludedPluginPackage = async (pluginPlatform, pluginInfo) => {
    return exports.addPluginPackage(pluginPlatform, pluginInfo.packageLocation);
};
exports.addPluginPackage = async (pluginPlatform, pluginDirPath) => {
