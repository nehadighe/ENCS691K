...
exports.showResourceTable = exports.getResourceStatus = void 0;
...
async function getResourceStatus(category, resourceName, providerName, filteredResources) {
    ...
    let tagsUpdated = compareTags(amplify_cli_core_1.stateManager.getProjectTags(), amplify_cli_core_1.stateManager.getCurrentProjectTags());
...
async function showResourceTable(category, resourceName, filteredResources) {
    ...
    const { resourcesToBeCreated, resourcesToBeUpdated, resourcesToBeDeleted, allResources, tagsUpdated } = await getResourceStatus(category, resourceName, undefined, filteredResources);
    let noChangeResources = lodash_1.default.differenceWith(allResources, resourcesToBeCreated.concat(resourcesToBeUpdated), lodash_1.default.isEqual);
