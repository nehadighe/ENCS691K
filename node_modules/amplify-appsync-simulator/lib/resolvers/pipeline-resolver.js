...
var AppSyncPipelineResolver = /** @class */ (function (_super) {
    ...
    AppSyncPipelineResolver.prototype.resolve = function (source, args, context, info) {
        return __awaiter(this, void 0, void 0, function () {
            var requestMappingTemplate, responseMappingTemplate, result, stash, templateErrors, isReturn, prevResult, _i, _a, fnName, fnResolver;
            var _b, _c, _d;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        (_b = requestMappingTemplate.render({ source: source, arguments: args, stash: stash }, context, info), result = _b.result, stash = _b.stash, templateErrors = _b.errors, isReturn = _b.isReturn);
                    ...
                    case 2:
                        (_c = _e.sent(), prevResult = _c.result, stash = _c.stash);
                        _e.label = 3;
                    case 3:
                        _i++;
                        return [3 /*break*/, 1];
